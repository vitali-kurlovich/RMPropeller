...
#ifndef RMPROPELLER_VBOTORUS_HPP
#define RMPROPELLER_VBOTORUS_HPP
...
namespace rmengine {
    ...
    namespace graphics {
        ...
        {
            float ringFactor = 2*M_PI / rings;
            float sideFactor = 2*M_PI / sides;
            int idx = 0, tidx = 0;
...
#endif //RMPROPELLER_VBOTORUS_HPP
